...
function useParams(opts) {
  return useMatch({
    ...opts,
    select: (match) => {
      return (opts == null ? void 0 : opts.select) ? opts.select(match.params) : match.params;
    }
  });
}
...
function useNavigate(_defaultOpts) {
  ...
  return React6.useCallback(result, []);
}
...
var useTransition2 = React7.useTransition || (() => [
  false,
  (cb) => {
    cb();
  }
...
function createLink(Comp) {
  return React10.forwardRef(function Link2(props, ref) {
    return (0, import_jsx_runtime6.jsx)(Link2, { ...props, _asChild: Comp, ref });
  });
}
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3BTOERCH.js.map
